...
今天看到 Go1.18 終於推出 [RC1 版本][2]了，離正式 Release 又跨出一大步了。繼上一篇『[初探 golang 1.18 generics 功能][1]』教學後，本次來看看 go1.18 推出三個新的 Package: [constraints][3], [slices][4] 及 [maps][5] 使用方式。目前這三個 Package 放在 x/exp 內，等到正式 Release 就會是內建的了。
