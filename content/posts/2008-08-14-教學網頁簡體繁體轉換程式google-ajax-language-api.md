---
title: '[教學]網頁簡體繁體轉換程式(Google AJAX Language API)'
author: appleboy
type: post
date: 2008-08-14T09:14:42+00:00
url: /2008/08/教學網頁簡體繁體轉換程式google-ajax-language-api/
views:
  - 13961
bot_views:
  - 1368
...
---
在 [PTT][1] PHP 版看到一篇：[[請益]簡體字轉繁體字的方法][2]，然後裡面其實有推文說可以用看看 [Google AJAX Language API][3]，然後我自己去測試，發現只要文字一多，[google][4] 就轉換不出來了，就會出現無效果，我自己也回一篇 [Re: [請益]簡體字轉繁體字的方法][5]，其實問題出在哪裡，我也不確定，這可能要問 [google][4] 了，不然 google 提供的這個還蠻方便的，可以即時整合到網站裡面。 **update：google API 不能用的原因，就是轉換的字數超過限制** 嗯嗯，後來改用[【原創】深藍UTF-8正體簡體轉換函數 1.0][6] 裡面這套 VBB 系統提供的簡體繁體轉換，大概看一下原始碼，就可以使用了，不會很難，只要在網頁 header 端加上： 
...
<http://blog.wu-boy.com/wp-content/google/google1.htm> <-- 不能轉換 <http://blog.wu-boy.com/wp-content/google/google2.htm> <-- 可以轉換 <http://code.google.com/apis/ajaxlanguage/documentation/reference.html#translateResult> 這裡面寫到，錯誤原因找到了： **the string to be translated exceeds the maximum length allowed** 囧 google 還沒完全開放阿～

 [1]: http://www.ptt.cc
 [2]: http://www.ptt.cc/bbs/PHP/M.1218595508.A.8C4.html
 [3]: http://code.google.com/apis/ajaxlanguage/documentation/
 [4]: http://www.google.com
 [5]: http://www.ptt.cc/bbs/PHP/M.1218697288.A.440.html
 [6]: http://www.twvbb.com/vbb/thread/24/572/2/