...
- 培養 PM 視角——今天能管 1 小時的 AI 任務，將來才能管 1 週的
...
舉個 DevOps 圈的例子：寫一支「Gitea Webhook 觸發後送通知到 Slack」的小工具，是 leaf——壞了重啟、回滾就好。但去動 [Kubernetes Operator][operator] 的 reconciliation loop？那是 core，因為叢集裡所有 CR 都依賴它。判定標準下節再展開。
